...
export default function NoteList({ notes, onEdit, onDelete }) {
  ...
  const [cards, setCards] = useState({}); // noteId -> JSON string (array)
          ...
          <div key={n.id} style={{ background: "#f8fafc", border: "1px solid #e5e7eb", borderRadius: "12px", padding: "1rem" }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", gap: ".75rem" }}>
              <div>
                ...
                <span style={{ marginLeft: ".5rem", fontSize: ".7rem", background: "#e2e8f0", color: "#334155", padding: ".1rem .45rem", borderRadius: "999px" }} title="Build tag">
                  v2 ✅
                </span>
              </div>
